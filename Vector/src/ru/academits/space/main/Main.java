...
public class Main {
    public static void main(String[] args) {
        ...
        Vector vector9 = vector.getUnfolding();
        ...
        int index = 2;
        System.out.printf("Элемент под индексом %d = %f%n", index, vector.getIndex(index));

        int index2 = 2;
        double x = 5.6;
        vector3.setIndex(index2, x);
        System.out.printf("Полученный вектор10 с новым значением: %s%n", vector3);

        double[] a7 = {3, 6, 9.0000, 0, 0, 0};
        vector = new Vector(a7);
        double[] b3 = {3, 6, 9.0001, 0, 0, 0};
        ...
        Vector vector11 = Vector.getAddition2(vector, vector2);
        ...
        Vector vector12 = Vector.getSubtraction2(vector, vector2);
        System.out.printf("Полученный вычитанием вектор12: %s%n", vector12);

        double[] a10 = {3, 6, 9.0001, 0, 0, 0};
        vector = new Vector(a10);

        Vector vector13 = Vector.getMultiplicationScalar2(vector, scalar);
